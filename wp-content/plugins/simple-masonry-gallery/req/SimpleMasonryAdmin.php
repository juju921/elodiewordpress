...
class SimpleMasonryAdmin {
	...
	function is_my_plugin_screen() {
		...
		if (is_object($screen) && $screen->id == 'settings_page_simplemasonry') {
			return TRUE;
		} else {
			return FALSE;
		}
	 ...
	 -->
	  ...
	  <div id="simplemasonry-admin-tabs-2">
		...
		<div class="wrap">
			...
			<a style="text-decoration: none;" href="https://wordpress.org/support/view/plugin-reviews/simple-masonry-gallery" target="_blank"><?php _e('Reviews', 'simplemasonry') ?></a>
			</h4>
